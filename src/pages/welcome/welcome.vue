...
<<<<<<< HEAD
						...
						//var url = "https://rfd.roletask.com/Rose/#/welcome?code=4YJ5psqjLSdlgcqXXqHmP56zIIXH9o4OooICgWOELW4&state=1";
						// 判断是否是从推送消息进来			
...
=======
	...
	// 					console.log("进入了")
	// 					var url = location.href;	
	// 					//var url = "https://rfd.roletask.com/Rose/?code=CF4lqgeF5NCf4WFK6cyrC0IFLZyyqnKkOn1RUBLIb-Q&state=1";
	// 					// 判断是否是从推送消息进来			
	// 					if(url.indexOf('code')>0){				
	// 						var arr = url.split("?");
	// 						var arr1 = arr[1].split("&")
	...
	// 							that.$router.replace("/to_do");				
	// 						})				
>>>>>>> d37bdbf271d557c556c97ecb9b1f55cf7868c5f5
