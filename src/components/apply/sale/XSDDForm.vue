      ...
      getFormData() {
        return getSOList({
          ...
          this.dealerInfo = {
            ...
            province: order.province_dealerDebit,
            city: order.city_dealerDebit,
            county: order.county_dealerDebit,
            address: order.address_dealerDebit,
            paymentTerm: order.drDealerPaymentTerm, // 结算方式
