  ...
  computed: {
    ...
    tipsWord() {
      ...
      let viewList = {
        ...
        view_62: '往来名称/往来编码/往来标签/账龄天数',
        view_63: '往来名称/往来编码/往来标签/账龄天数',
        view_69: '往来名称/往来编码/往来标签/账龄天数',
        view_92: '往来名称/往来编码/往来标签/账龄天数',
        view_55: '往来名称/往来编码/往来标签/账龄天数',
        view_152: '应用名称/往来编码/往来标签/字段分组'
      };
