  ...
  <div class="detail_wrapper">
    ...
    <div class="title">
      ...
      <div class="group-container">
        <div class="group-button" :class="{activeGroup:typeFlag==='num'}">
            <div @click="changeType('按资金账户分组')">资金账户</div>
        </div>
        <div class="group-button" :class="{activeGroup:typeFlag==='type'}">
            <div @click="changeType('按账户类型分组')">账户类型</div>
          </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        var data = {
          _dc: Date.now(),
          strViewId: '466858f9-8443-4846-a985-313d2a2d3488',
      ...
      groupByType(data,type){
        ...
        return Object.keys(groups).map(function (group) {
          ...
          for(var i = 0; i < groups[group].length; i++){
            ...
            arr.cashCode = groups[group][i]['cashCode'];
            arr.cashOutCode_fundName = groups[group][i]['cashOutCode_fundName'];
            arr.cashOutCode_bank = groups[group][i]['cashOutCode_bank'];
            arr.cashOutCode_fundType = groups[group][i]['cashOutCode_fundType'];
