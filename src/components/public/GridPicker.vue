    ...
    >
      ...
      <div class="matter-list-container">
        ...
        >
          <div
            class="each-matter"
            :class="{'vux-1px-b': index !== data.length - 1}"
  ...
  methods: {
    ...
    initStore: function() {
      ...
      function setParams(params) {
        var paramCfg, key, valueField, contrl, value, contrlId;
        ...
        if (params)
          for (key in params) {
            ...
            if (paramCfg.type == "contrl") {
              ...
              me.form.$on(
                "value-change-" + contrlId,
                (function(paramKey, valueField) {
                  return function() {
