<template>
  <div class="aca_part vux-1px-t swiper-container">
    <!-- 应用标题 -->
    <div class="list_title">
      <span class="bg_title">调拨与财务</span>
    ...
    <div class="app_list swiper-wrapper">
      ...
      <div class="each_app swiper-slide"
          @click='goList(item.code)'
          v-for="(item, index) of ACAarray"
          :key='index'>
