<template>
  <div class="detail_wrapper">
    <div class="basicPart" v-if='orderInfo && orderInfo.order'>
      ...
      <div class="form_part">
        ...
        <div class="form_content"
          ...
          <div class="main_content">
            ...
            <form-cell cellTitle='兑现贴现日' :cellContent="item.cashingDiscountDate"></form-cell>
            <form-cell cellTitle='贴息' :cellContent="item.discount"></form-cell>
            <form-cell cellTitle='现后金额' :cellContent="item.thenAmntBal | toFixed | numberComma(3)"></form-cell>
      ...
      <div class="form_part">
        <div class="form_title vux-1px-b">
          <span class="iconfont icon-baoxiao"></span><span class="title">资金账户明细</span>
        </div>
        <div class="form_content">
          <div class="main_content">
            <form-cell cellTitle='资金账户' :cellContent="cashInfo.fundName_cashInCode" :showTopBorder=false></form-cell>
            ...
            <form-cell cellTitle='收款金额' :cellContent="cashInfo.tdAmount | toFixed | numberComma(3)"
                       showSymbol></form-cell>
          </div>
        </div>
      </div>
