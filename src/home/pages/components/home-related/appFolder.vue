<template>
    ...
    <div class="app-container defalut_bg" v-if="Object.values(item.appList).length > 0">
        ...
        <div class="app-list">
            <app :app="app" cls="indval_app"  @app-click='goList(item.folder, app.packagePath, app.text, app.listId )'
        ...
        <div v-if="app.childName" class="each_child" 
            ...
            <app :app="child" cls="child_apps" @app-click='goList(item.folder, child.packagePath, child.text, child.listId)'
