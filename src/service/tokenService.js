  ...
  login() {
    ...
    if (isDebug){
      ...
      if(code != null){
        ...
        window.location.replace("https://open.weixin.qq.com/connect/oauth2/authorize?appid=${corpid}&"+encodeURI("redirect_uri="+redUrl)+"&response_type=code&scope=SCOPE&agentid=${agentid}&state=1#wechat_redirect")
      }
