            ...
            if(group != this.group){
                ...
                getGroupMsg(groupId).then(res=>{
                    ...
                    var data4 = {
                        ...
                        crtTime: "2020-09-04 09:00:00",
                        imType: 211,
                        content: [{"groupId":"b171c44c1e2cffea7f20da05666e1094","imType":211,"content":{"id":"文件ID","size":"文件大小","content":"文件名称","creator":"创建者","transCode":"任务交易号","taskName":"任务名称","executor":"执行者"}}],
                        allRead: true,
                        checked: 0,
                        id: "6844e826-fef9-4e4a-8dfa-b41ec87a3dd5",
                        replayId: null,
