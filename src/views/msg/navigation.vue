            ...
            if(group != this.group){
                ...
                getGroupMsg(groupId).then(res=>{
                    ...
                    var data = {
                        ...
                        imType: 207,
                        content: {"groupId":"b171c44c1e2cffea7f20da05666e1094","imType":207,"content":{"projectName":"xxx项目","taskName":"销售合同签订","startTime":"2020-09-04 09:00:00","endTime":"2020-09-24 09:00:00"}},
                        allRead: true,
                        checked: 0,
